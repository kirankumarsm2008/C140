    ...
    $("button.send-button").click(function () {
        ...
        if (user_bot_input_text != "") {
            ...
            $.ajax({
                ...
                //  URL of the API endpoint that receives chat input and returns bot response
                url: "http://example.com/chatbot_api/",
                ...
                success: function (result) {
                    ...
                    //  scroll to the bottom of the chat window to show latest message
